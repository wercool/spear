...
void loop() {
  ...
  Serial.print("Magnetometer Sample: \t");
  Serial.print(magSample.X); Serial.print("\t");
  Serial.print(magSample.Y); Serial.print("\t");
  Serial.println(magSample.Z);
